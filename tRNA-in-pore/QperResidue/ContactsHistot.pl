...
open($OUTPUTFILE,">$XTCFILENAME.QwhamHist_ot") or die "couldn't open the QWHAMhist file";

open($wtOUTPUTFILE,">$XTCFILENAME.QwhamHistwt_ot") or die "couldn't open the QWHAMhistwt file";
